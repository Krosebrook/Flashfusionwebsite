...
For detailed information about the automation system, see [.github/PR_AUTOMATION.md](.github/PR_AUTOMATION.md).
...
4. Manual approval required for non-Copilot PRs

See [CONTRIBUTING.md](./src/CONTRIBUTING.md) for detailed contribution guidelines.
...
See [PDR_EXECUTIVE_SUMMARY.md](./PDR_EXECUTIVE_SUMMARY.md) for detailed status.
...
- **Figma Design:** [View on Figma](https://www.figma.com/design/8kPZxN1nfg3DN1gdwYahiS/FlashFusionWebsite)
