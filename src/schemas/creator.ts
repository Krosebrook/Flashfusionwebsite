 ...
 */
export const GeneratedCaptionSchema = z
  .object({
    ...
    text: z
      ...
      .max(2200, 'Caption too long for most platforms'),
    /** Target platform */
    ...
    brand_alignment_score: z
      .number()
      .min(0)
      .max(100, 'Brand alignment score must be between 0-100'),
    /** Creation timestamp */
    created_at: z.string().datetime('Must be a valid ISO datetime'),
  })
  .strict();
 ...
 */
export const ContentCalendarEventStatusSchema = z.enum([
  'draft',
  'scheduled',
  'published',
  'failed',
 ...
 */
export const ContentCalendarEventSchema = z
  .object({
 ...
 */
export const CreatorModuleSchema = z
  .object({
    ...
    pain_point: z
      .string()
      .min(5, 'Pain point must be described')
      .max(200, 'Pain point description too long'),
    /** Current usage count */
 ...
 */
export const ViralFormatSchema = z
  .object({
 ...
 */
export const HashtagSetSchema = z
  .object({
...
export const ContentTemplateSchema = z
  .object({
    ...
    template_content: z
      .string()
      .min(10, 'Template content is required')
      .max(2000, 'Template content too long'),
 ...
 */
export const CreatorInsightSchema = z
  .object({
 ...
 */
export const CreatorMetricsSchema = z
  .object({
