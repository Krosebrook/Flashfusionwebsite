...
const EDUCATIONAL_TOOL_CATEGORIES = [
  {
    ...
    tools: [
      {
        name: 'Differentiated Lesson Plans',
        description: 'Generate lessons for multiple learning levels',
        popular: true,
      },
      {
        name: 'Curriculum Map Generator',
        description: 'Year-long pacing guides aligned to standards',
        popular: true,
      },
      {
        name: 'Unit Plan Creator',
        description: 'Comprehensive unit planning with assessments',
        popular: false,
      },
      {
        name: 'Cross-Curricular Integrator',
        description: 'Connect subjects with interdisciplinary activities',
        popular: false,
      },
    ],
  },
  {
    ...
    tools: [
      {
        name: 'Quiz & Test Generator',
        description: 'Auto-generate multiple choice and short answer tests',
        popular: true,
      },
      { name: 'Rubric Builder', description: 'Create detailed assessment rubrics', popular: true },
      {
        name: 'Portfolio Assessment',
        description: 'Student work portfolio evaluation tools',
        popular: false,
      },
      {
        name: 'Peer Assessment Tools',
        description: 'Student-to-student evaluation frameworks',
        popular: false,
      },
    ],
  },
  {
    ...
    tools: [
      ...
      { name: 'Flashcard Creator', description: 'AI-generated study flashcards', popular: true },
      {
        ...
        description: 'Thesis generation and citation help',
        popular: true,
      },
      {
        name: 'Practice Problem Generator',
        description: 'Subject-specific practice questions',
        popular: false,
      },
    ],
  },
  {
    ...
    tools: [
      {
        name: 'AI Slide Deck Creator',
        description: 'Auto-design presentations with content',
        popular: true,
      },
      {
      ...
      },
      {
        ...
        description: 'Safe online laboratory experiences',
        popular: false,
      },
      {
        name: 'AR/VR Learning Modules',
  ...
  },
  {
    ...
    tools: [
      {
        name: 'Parent Newsletter Generator',
        description: 'Weekly classroom update templates',
        popular: true,
      },
      {
        name: 'Progress Report Creator',
        description: 'Individual student progress summaries',
        popular: true,
      },
      {
        name: 'Conference Scheduler',
        description: 'Parent-teacher meeting coordination',
        popular: false,
      },
      {
        name: 'Behavioral Tracker',
        description: 'Student behavior monitoring and reporting',
        popular: false,
      },
    ],
  },
  {
    ...
    tools: [
      {
        name: 'Printable Worksheet Designer',
        description: 'Professional educational printables',
        popular: true,
      },
      {
        name: 'Study Planner Templates',
        description: 'Student organization and planning tools',
        popular: true,
      },
      {
        name: 'Exam Prep Kit Builder',
        description: 'Comprehensive test preparation packages',
        popular: false,
      },
      {
        name: 'Teacher Resource Bundler',
        description: 'Complete curriculum resource packages',
        popular: false,
      },
    ],
  },
  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-6">
        ...
        >
          Discover and access AI-powered educational tools designed for educators, students, and
          content creators. Generate lesson plans, assessments, study materials, and interactive
        ...
        <CardContent>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {EDUCATIONAL_TOOL_CATEGORIES.flatMap((cat) =>
              cat.tools.filter((tool) => tool.popular).map((tool) => ({ ...tool, category: cat }))
            )
              .slice(0, 8)
              .map((tool, index) => (
                <div
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-1 mt-3">
                    <Star className="w-3 h-3 fill-current" style={{ color: 'var(--ff-warning)' }} />
                    <span
                      style={{
                        fontSize: 'var(--ff-text-xs)',
                        color: 'var(--ff-warning)',
      ...
      <div className="text-center space-y-6 max-w-4xl mx-auto">
        <div>
          ...
          >
            ...
            FlashFusion's AI-powered educational tools to create engaging, effective learning
            experiences.
          </p>
        </div>
