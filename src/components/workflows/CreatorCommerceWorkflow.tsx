...
export function CreatorCommerceWorkflow({
  createdContent,
  publishedContent,
  onComplete,
}: CreatorCommerceWorkflowProps) {
        ...
        return (
          <div className="space-y-6">
                          ...
                          <div className="flex items-start justify-between">
                            <div className="flex items-center space-x-3">
                              ...
                              <div>
                                ...
                                {stream.recommended && (
                                  <Badge className="ff-badge-primary text-xs mt-1">
                                    Recommended
                                  </Badge>
                                )}
                              </div>
            ...
            <div className="flex justify-center">
              ...
              >
                Configure Commerce ({selectedRevenueStreams.length} stream
                {selectedRevenueStreams.length !== 1 ? 's' : ''})
        ...
        return (
          <div className="space-y-6">
                  ...
                  <CardContent className="p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <Input placeholder="$99.00" className="ff-input" defaultValue="$149.00" />
                      </div>
                        ...
                        >
                          <div className="space-y-1">
                            ...
                            <div className="text-sm text-gray-400">
                              {marketplace.audience} • {marketplace.commission} commission • $
                              {marketplace.avgSale} avg sale
                            </div>
            ...
            <div className="flex justify-between">
              ...
              <Button onClick={handleSetupCommerce} className="ff-btn-primary ff-btn-lg">
          ...
          <div className="space-y-6">
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="ff-text-body">
                  Configuring your revenue streams and marketplace integrations
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="ff-text-body">
                  Your revenue streams are now configured and ready to generate income
                </p>
              </div>
            </div>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-400">
                              Setup completed in {stream.setupTime}
                            </p>
                          </div>
                        </div>
                        ...
                        >
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-400">
                                {marketplace.listingsCreated} listings created •{' '}
                        ...
                        <div className="space-y-3">
                          <div className="p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                            ...
                            <p className="text-xs text-green-400">
                              Increase prices by 15% to maximize revenue
                            </p>
                          </div>
                          ...
                          <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                            ...
                            <p className="text-xs text-blue-400">
                              Add 2 more marketplaces for 40% reach increase
                            </p>
                          </div>
                          ...
                          <div className="p-3 bg-purple-500/10 border border-purple-500/20 rounded-lg">
                            ...
                            <p className="text-xs text-purple-400">
                              A/B test checkout flow for 12% conversion lift
                            </p>
                          </div>
                        </div>
                      </CardContent>
      ...
      <div className="flex items-center justify-center space-x-4 mb-8">
        {[1, 2, 3, 4].map((step) => (
          <div key={step} className="flex items-center">
            ...
            {step < 4 && (
              <div
                className={`w-16 h-1 mx-2 ${step < currentStep ? 'bg-green-500' : 'bg-gray-700'}`}
              />
            )}
          </div>
        ))}
