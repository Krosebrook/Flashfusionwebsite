...
export function EnterpriseSecuritySuite() {
  const [activeTab, setActiveTab] = useState<
    'overview' | 'threats' | 'compliance' | 'vulnerabilities' | 'analytics'
  >('overview');
  ...
  const [threats, setThreats] = useState<ThreatDetection[]>([
    {
      ...
      description:
        'Detected abnormal API access patterns from IP 192.168.1.100 with 300% higher than normal request volume',
      source: 'API Gateway',
    ...
    },
    {
      ...
      description:
        'Multiple failed authentication attempts detected from various IPs targeting admin accounts',
    ...
    },
    {
      ...
      description:
        'Several npm packages with known vulnerabilities detected in production environment',
      ...
      riskScore: 5.4,
      recommendation:
        'Update to latest secure versions and implement automated dependency scanning',
    },
  ]);
    ...
    () => [
      {
        ...
        description:
          'SQL injection vulnerability in user profile update endpoint allowing unauthorized data access',
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <h1 className="ff-text-display">
            Security &<span className="ff-text-gradient"> Compliance</span>
          </h1>
                        ...
                        <CardContent className="p-6">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center">
                              ...
                              <div>
                                <div
                                  className="ff-text-sm text-[var(--ff-error)]"
                                  style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                                >
                              ...
                              <div>
                                <div
                                  className="ff-text-sm text-[var(--ff-warning)]"
                                  style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                                >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Badge className="ff-badge-warning">
                      {
                        vulnerabilities.filter(
                          (v) => v.severity === 'high' && v.status !== 'resolved'
                        ).length
                      }{' '}
                      High
                    </Badge>
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                  ...
                                  <Badge className="ff-badge-secondary text-xs">{vuln.cve}</Badge>
                                  <StatusIcon
                                    className="w-4 h-4"
