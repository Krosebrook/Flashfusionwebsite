...
// Mock data constants imported from fixtures
...
Create engaging, platform-optimized content that resonates with the target audience and drives engagement.`;
  ...
  const analyzeContent = async (content: string, platform: string): Promise<ContentAnalytics> => {
    ...
    const engagement_potential = Math.min(
      100,
      engagementFactors.reduce((a, b) => a + b, 40)
    );
  ...
  const generateSingleContent = async (platform: string) => {
    ...
    try {
      ...
      setGeneratedContent((prev) => prev.map((c) => (c.platform === platform ? newContent : c)));
    ...
    <div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center space-y-4 mb-8">
          <h1 className="text-3xl font-bold ff-text-gradient">AI Content Generator</h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Create engaging, platform-optimized content with AI. From social posts to long-form
            articles.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              setConfig((prev) => ({
                                ...prev,
                                platform: [...prev.platform, platform.value],
                              }));
                            } else {
                              setConfig((prev) => ({
                                ...prev,
                                platform: prev.platform.filter((p) => p !== platform.value),
                              }));
                            }
                          }}
                          className="ff-focus-ring"
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setConfig((prev) => ({ ...prev, includeHashtags: !!checked }))
                      }
                      className="ff-focus-ring"
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setConfig((prev) => ({ ...prev, includeEmojis: !!checked }))
                      }
                      className="ff-focus-ring"
                    />
                  ...
                  <div className="flex items-center space-x-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) =>
                        setConfig((prev) => ({ ...prev, includeCTA: !!checked }))
                      }
                      className="ff-focus-ring"
                    />
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setConfig((prev) => ({ ...prev, targetLanguage: value }))
                    }
                  >
                    <SelectTrigger className="ff-focus-ring">
                      <SelectValue />
                  ...
                  <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{generatedContent.length} platforms</Badge>
                    ...
                    <CardHeader>
                      <CardTitle className="flex items-center justify-between">
                        <span className="flex items-center gap-2">
                          ...
                          {PLATFORMS.find((p) => p.value === selectedContent.platform)?.label}{' '}
                          Content
                        </span>
                    ...
                    <CardContent className="space-y-6">
                      ...
                      {(() => {
                        const platform = PLATFORMS.find(
                          (p) => p.value === selectedContent.platform
                        );
                        if (platform?.limit) {
                          const isOverLimit = selectedContent.character_count > platform.limit;
                          return (
                            <div
                              className={`p-3 rounded-lg ${isOverLimit ? 'bg-destructive/10 border border-destructive/20' : 'bg-success/10 border border-success/20'}`}
                            >
              ...
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Configure your content settings and click "Generate Content" to create engaging,
