...
export function EnhancedAuthenticationSystem({
  ...
  const handlePromoError = useCallback(
    (error: string) => {
  ...
  const getSubtitle = () => {
    switch (authMode) {
      case 'signin':
        return 'Sign in to access your FlashFusion workspace';
      case 'signup':
        return 'Join thousands of creators building with AI';
      case 'forgot-password':
        return "We'll send you a link to reset your password";
      case 'demo':
        return 'Experience FlashFusion without creating an account';
      default:
        return '';
    }
  };
        ...
        <Card className="w-full max-w-md bg-[var(--ff-surface)] border-[var(--ff-primary)]/20 shadow-2xl">
          <CardHeader className="relative space-y-4 pb-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-[var(--ff-text-muted)]">{getSubtitle()}</p>
            </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <div className="space-y-1 text-xs text-[var(--ff-text-muted)]">
                        <p>
                          <strong>Email:</strong> demo@flashfusion.ai
                        </p>
                        <p>
