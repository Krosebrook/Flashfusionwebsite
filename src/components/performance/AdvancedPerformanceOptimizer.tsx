...
export function AdvancedPerformanceOptimizer() {
  const [activeTab, setActiveTab] = useState<
    'overview' | 'vitals' | 'budget' | 'cache' | 'optimization'
  >('overview');
    ...
    () => [
      {
        ...
        description:
          'Font budget exceeded by 25KB. Implement font-display: swap and preload critical fonts.',
      ...
      },
      {
        ...
        description:
          'Implement route-based and component-based code splitting for better chunking.',
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto">
            ...
            intelligent caching, performance budget enforcement, and automated optimization
            recommendations.
          </p>
        </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="ff-text-xs text-[var(--ff-text-primary)]">
                      {Math.round(cacheMetrics.avgResponseTime)}ms
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="ff-text-xs text-[var(--ff-text-muted)]">TTFB</span>
                    <span className="ff-text-xs text-[var(--ff-text-primary)]">
                      {Math.round(coreWebVitals.ttfb)}ms
                    </span>
                  </div>
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              >
                                {vital.value.toFixed(
                                  vital.key === 'cls'
                                    ? 3
                                    : vital.key.includes('fid') || vital.key.includes('ttfb')
                                      ? 0
                                      : 1
                                )}
                                {vital.unit}
                    ...
                    <Card key={category} className="ff-card">
                      <CardContent className="p-4">
                        <div className="flex items-center justify-between mb-3">
                          <div className="flex items-center gap-3">
                            <div
                              className="capitalize ff-text-sm text-[var(--ff-text-primary)]"
                              style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                            >
