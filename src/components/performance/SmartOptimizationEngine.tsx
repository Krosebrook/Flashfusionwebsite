    ...
    const baseRecommendations: OptimizationRecommendation[] = [
      {
        ...
        description:
          'Convert images to next-gen formats (WebP, AVIF) and implement lazy loading to reduce initial page load time by 35-45%',
        ...
        technical_details:
          'Utilize modern image formats and implement intersection observer for lazy loading',
      ...
      },
      {
        ...
        description:
          'Implement route-based and component-based code splitting to reduce initial bundle size and improve Time to Interactive',
        category: 'performance',
        priority: 'high',
        impact: {
          performance: 80,
      ...
      },
      {
        ...
        description:
          'Improve accessibility score from 74% to 95%+ by implementing ARIA labels, keyboard navigation, and screen reader optimization',
      ...
      },
      {
        ...
        description:
          'Implement multi-layered caching including service workers, CDN optimization, and intelligent cache invalidation',
        category: 'performance',
        priority: 'critical',
        impact: {
          performance: 90,
        ...
        technical_details:
          'Combine browser caching, service workers, and CDN for optimal performance',
      ...
      },
      {
        ...
        description:
          'Optimize mobile user experience to reduce bounce rate by 25% and improve mobile conversion rates',
        category: 'ux',
        priority: 'high',
        impact: {
          performance: 60,
        ...
        technical_details:
          'Focus on touch targets, thumb-friendly navigation, and mobile-specific interactions',
      ...
      },
      {
        ...
        description:
          'Implement structured data, improve Core Web Vitals, and optimize for featured snippets to increase organic traffic by 30-40%',
        category: 'seo',
        priority: 'medium',
        impact: {
          performance: 40,
        ...
        technical_details:
          'Use JSON-LD structured data and optimize for Google page experience signals',
    ...
    const plans: OptimizationPlan[] = [
      {
        ...
        description:
          'Comprehensive performance optimization focusing on Core Web Vitals and user experience improvements',
      ...
      },
      {
        ...
        description:
          'Focus on making the platform more accessible and user-friendly across all devices',
              ...
              <CardContent className="pt-6">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="ff-text-sm text-muted-foreground">{analysisProgress}%</span>
                  </div>
        ...
        <CardContent>
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4">
            <div className="text-center p-4 rounded-lg bg-muted/30">
              <div
                className={`ff-text-3xl font-bold ${getScoreColor(performanceScore.overall)} font-sora`}
              >
                      ...
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Button
                            ...
                            className="ff-btn-primary ff-hover-glow"
                            onClick={() =>
                              updateRecommendationStatus(recommendation.id, 'in_progress')
                            }
                          >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted/30 rounded-lg">
                        {Object.entries(recommendation.impact).map(([metric, value]) => (
                          <div key={metric} className="text-center">
                            <div
                              className={`ff-text-lg font-bold ${getScoreColor(value)} font-sora`}
                            >
                              {value}%
                            </div>
                            <p className="ff-text-xs text-muted-foreground capitalize font-inter">
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="space-y-1">
                        ...
                        <p className="ff-text-sm text-green-600 font-semibold">
