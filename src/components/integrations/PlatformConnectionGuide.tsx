    ...
    troubleshooting: [
      {
        ...
        solution:
          'Clear browser cookies for Bolt.new and try again. Ensure popup blockers are disabled.',
      },
      {
      ...
      },
      {
        ...
        solution:
          'Verify the webhook URL is correctly configured and your app has webhook permissions.',
      },
    ],
    examples: [
      {
    ...
    troubleshooting: [
      {
        ...
        solution:
          'Make sure you copied the full token and it has the required permissions for reading repls.',
      },
      {
      ...
      },
      {
        ...
        solution:
          'Check that your Replit project is properly connected to GitHub and has recent commits.',
      },
    ],
    examples: [
      {
    ...
    troubleshooting: [
      {
        ...
        solution:
          "Make sure you're logged into the correct Vercel account and have team permissions.",
      },
      {
        issue: 'Webhooks not firing',
        solution:
          'Check that the webhook URL is correctly configured in your Vercel project settings.',
      },
    ],
    examples: [
      {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="ff-text-display text-4xl mb-2">Platform Connection Guides</h1>
            ...
            <Card className="ff-card">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  >
                    <ProfessionalIcon icon={guide.icon} size="xl" style={{ color: guide.color }} />
                  </div>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <span>
                      {completedSteps.size}/{currentSteps.length}
                    </span>
                  </div>
              ...
              <CardContent className="space-y-4">
                {guide.troubleshooting.map((item, index) => (
                  <div key={index} className="space-y-2">
                    <h4 className="ff-text-caption font-semibold text-warning">{item.issue}</h4>
                    <p className="ff-text-caption text-muted-foreground">{item.solution}</p>
            ...
            <Card className="ff-card">
              ...
              <CardContent className="space-y-4">
                {guide.examples.map((example, index) => (
                  <div key={index} className="space-y-2">
                    <h4 className="ff-text-caption font-semibold">{example.title}</h4>
