...
/**
 * Support channel configuration and health overview.
 */
    ...
    <>
      <Alert className="border-[var(--ff-warning)] bg-[var(--ff-warning)]/10">
        ...
        <AlertDescription className="text-[var(--ff-text-secondary)]">
          <strong className="text-[var(--ff-warning)]">Support Systems:</strong> Configure help desk, community forums, knowledge
          base, and customer success tools for post-launch support.
        </AlertDescription>
      </Alert>
