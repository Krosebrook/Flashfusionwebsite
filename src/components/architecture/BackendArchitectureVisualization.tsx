        ...
        {Object.values(architectureComponents).map((component) => {
          ...
          return (
            ...
            >
              ...
              {/* Metrics display */}
              {isSelected && (
                <foreignObject x={position.x - 80} y={position.y + 70} width="160" height="80">
        ...
        {activeFlow && isAnimating && (
          <g>
            {getFlowPath(activeFlow).map((segment, index) => (
              <circle key={index} r="4" fill={getFlowColor(activeFlow)} className="animate-pulse">
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto">
            Interactive visualization of our scalable backend architecture featuring Supabase edge
            functions, Hono web server, real-time data channels, and intelligent microservice
            orchestration.
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="ff-text-sm text-[var(--ff-text-muted)]">
                  Interactive diagram showing data flow and component relationships
                </p>
              </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className="ff-card">
            <CardHeader>
              ...
              <p className="ff-text-sm text-[var(--ff-text-muted)]">
                Visualize different request flows
              </p>
            </CardHeader>
                        ...
                        <Badge variant="outline" className="ff-text-xs">
                          {
                            architectureComponents[
                              step as keyof typeof architectureComponents
                            ]?.name.split(' ')[0]
                          }
                        </Badge>
          ...
          <Card className="ff-card lg:col-span-2">
            <CardHeader>
              <CardTitle className="ff-text-base">
                {selectedComponent
                  ? architectureComponents[selectedComponent as keyof typeof architectureComponents]
                      ?.name
                  : 'Component Details'}
              </CardTitle>
              <p className="ff-text-sm text-[var(--ff-text-muted)]">
            ...
            <CardContent>
              {selectedComponent ? (
                (() => {
                  const component =
                    architectureComponents[
                      selectedComponent as keyof typeof architectureComponents
                    ];
                  const Icon = getComponentIcon(component.type);
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start gap-4">
                        <div
                          ...
                          style={{
                            backgroundColor: `${getComponentColor(component.type, component.status)}20`,
                          }}
                        >
                          <Icon
                            className="w-6 h-6"
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            <h3 className="ff-text-lg text-[var(--ff-text-primary)]">
                              {component.name}
                            </h3>
                            <Badge
                              className={
                      ...
                      {component.connections.length > 0 && (
                        <div>
                          <h4 className="ff-text-sm text-[var(--ff-text-primary)] mb-3">
                            Connected Components
                          </h4>
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {component.connections.map((connId) => {
                              const connectedComponent =
                                architectureComponents[
                                  connId as keyof typeof architectureComponents
                                ];
                              ...
                              return (
                                ...
                                >
                                  <div
                                    ...
                                    style={{
                                      backgroundColor: `${getComponentColor(connectedComponent.type, connectedComponent.status)}20`,
                                    }}
                                  >
                                    <ConnIcon
                                      className="w-4 h-4"
                ...
                <div className="text-center py-12">
                  ...
                  <p className="ff-text-base text-[var(--ff-text-muted)]">
                    Click on any component in the architecture diagram to view detailed metrics and
                    connections.
                  </p>
                </div>
              )}
        ...
        <Card className="ff-card">
          <CardHeader>
            ...
            <p className="ff-text-body">
              Detailed breakdown of backend architecture components and capabilities
            </p>
          </CardHeader>
          <CardContent>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            >
                              <Icon
                                className="w-5 h-5"
                                style={{
                                  color: getComponentColor(component.type, component.status),
                                }}
                              />
                            </div>
                            <div>
                      ...
                      {[
                        ...
                        <div key={index} className="flex justify-between items-center">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {metric.trend === 'down' && (
                              <ArrowDown className="w-3 h-3 text-[var(--ff-success)]" />
                            )}
                            {metric.trend === 'stable' && (
                              <Activity className="w-3 h-3 text-[var(--ff-warning)]" />
                            )}
                          </div>
                        </div>
                      ))}
