    ...
    activities: [
      {
        ...
        description:
          'Conduct comprehensive stakeholder interviews and requirement gathering sessions',
        duration: 2,
        startDay: 1,
      ...
      },
      {
        ...
        description:
          'Document and validate all business requirements with clear acceptance criteria',
        duration: 3,
        startDay: 2,
        owner: 'Product Manager',
    ...
    activities: [
      {
        ...
        description:
          'Configure development, staging, and testing environments with proper CI/CD pipelines',
        duration: 3,
        startDay: 6,
      ...
      },
      {
        ...
        description:
          'Create comprehensive project timeline with milestones, dependencies, and resource allocation',
        duration: 2,
        startDay: 8,
        owner: 'Project Manager',
...
export function DiscoveryPhaseTimeline({}: DiscoveryPhaseTimelineProps) {
  ...
  const discoveryMetrics = useMemo(() => {
    const allActivities = [
      ...discoveryActivities.week1.activities,
      ...discoveryActivities.week2.activities,
    ];
    ...
    return {
      ...
      avgWorkload: Math.round(
        teamRoles.reduce((sum, role) => sum + role.workload, 0) / teamRoles.length
      ),
    };
  }, []);
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto">
            Comprehensive discovery phase timeline for finalizing business requirements, auditing
            technical architecture, establishing team roles, creating detailed project timeline, and
            setting up monitoring and deployment infrastructure.
          </p>
        </div>
        ...
        <Card className="ff-card">
          <CardContent className="p-0">
            <Tabs
              ...
              onValueChange={(value) =>
                setSelectedWeek(parseInt(value.replace('week', '')) as 1 | 2)
              }
              className="w-full"
            >
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="ff-text-sm text-[var(--ff-text-muted)] mt-1">
                      {discoveryActivities.week1.focus}
                    </p>
                  </div>
                  <Badge className="ff-badge-success">{discoveryActivities.week1.duration}</Badge>
                </div>
                ...
                {viewMode === 'gantt' && (
                  <div className="space-y-4">
                    <div className="grid grid-cols-12 gap-2 mb-4">
                      <div
                        className="col-span-4 ff-text-sm text-[var(--ff-text-muted)]"
                      ...
                      <div className="col-span-8 grid grid-cols-5 gap-1">
                        {[1, 2, 3, 4, 5].map((day) => (
                          <div
                            key={day}
                            className="text-center ff-text-xs text-[var(--ff-text-muted)]"
                          >
                            Day {day}
                          </div>
                        ))}
                                ...
                                <div className="grid grid-cols-5 gap-1 h-8">
                                  {[1, 2, 3, 4, 5].map((day) => {
                                    const isActive =
                                      ...
                                      day < activity.startDay + activity.duration;
                                    return (
                                      <div
                                        key={day}
              ...
              <TabsContent value="week2" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="ff-text-sm text-[var(--ff-text-muted)] mt-1">
                      {discoveryActivities.week2.focus}
                    </p>
                  </div>
                  <Badge className="ff-badge-success">{discoveryActivities.week2.duration}</Badge>
                </div>
                ...
                <Card key={index} className="ff-card">
                  <CardContent className="p-4">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <Badge
                        className={`ff-badge-${role.status === 'assigned' ? 'success' : 'warning'} text-xs`}
                      >
                        {role.status}
                      </Badge>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        <h5
                          className="ff-text-xs text-[var(--ff-text-primary)] mb-1"
                          style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                        >
