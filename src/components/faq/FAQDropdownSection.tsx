  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer:
        'FlashFusion is an AI-powered development platform that transforms your ideas into production-ready applications, content, and revenue streams. Our advanced AI models analyze your requirements and generate complete solutions including code, designs, content, and deployment configurations. Simply describe what you want to build, and FlashFusion handles the technical implementation.',
      category: 'general',
    ...
    },
    {
      ...
      answer:
        'FlashFusion supports 25+ platforms including social media (Twitter, Instagram, LinkedIn, TikTok), content platforms (Medium, Substack, WordPress), e-commerce (Shopify, Etsy, Amazon), development platforms (GitHub, Vercel, Netlify), and many more. We also support custom integrations and API connections for enterprise clients.',
      category: 'features',
    ...
    },
    {
      ...
      answer:
        "Yes! We offer a 14-day free trial with no credit card required. You'll get full access to all features including AI generations, publishing tools, analytics, and support. The trial includes everything in our Professional Pro plan so you can test all capabilities before committing to a subscription.",
      category: 'pricing',
      tags: ['trial', 'free', 'testing'],
      helpfulCount: 178,
      relatedLinks: [{ title: 'Start Free Trial', url: '/signup?trial=true', type: 'external' }],
    },
    {
      id: 'data-security',
      question: 'How secure is my data and content?',
      answer:
        'We use enterprise-grade security with end-to-end encryption, SOC 2 compliance, and regular security audits. Your data is stored in secure, encrypted databases with multiple backups. We never use your data to train AI models without explicit permission, and you maintain full ownership and control over your content and intellectual property.',
      category: 'security',
    ...
    },
    {
      ...
      helpfulCount: 145,
      relatedLinks: [{ title: 'How to Cancel', url: '/docs/cancel-subscription', type: 'docs' }],
    },
    {
      id: 'api-access',
      question: 'Do you provide API access for developers?',
      answer:
        "Yes! Professional Pro and Enterprise Pro plans include full API access with comprehensive documentation, SDKs for popular languages, webhooks, and rate limiting. Our API allows you to integrate FlashFusion's AI capabilities directly into your applications, automate workflows, and build custom solutions on top of our platform.",
      category: 'technical',
    ...
    },
    {
      ...
      answer:
        'Enterprise Pro plans include custom AI model training capabilities. You can train models on your specific data, industry terminology, brand voice, and use cases. This creates personalized AI that understands your business context and generates more relevant, on-brand content. Custom training is available with dedicated support and deployment options.',
      category: 'features',
    ...
    },
    {
      ...
      answer:
        'All plans include email support with response within 24 hours. Professional plans get priority support with faster response times. Enterprise customers receive 24/7 phone support, dedicated success managers, and SLA guarantees. We also provide extensive documentation, video tutorials, community forums, and regular webinars.',
      category: 'general',
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <h2 className="ff-text-headline">Frequently Asked Questions</h2>
        </div>
          ...
          <Card className="ff-card p-8 text-center">
            <CardContent>
              ...
              <p className="text-[var(--ff-text-muted)] ff-text-body mb-4">
                We couldn't find any FAQs matching your search. Try adjusting your search terms or
                browse by category.
              </p>
              <Button
                onClick={() => {
      ...
      <div className="text-center space-y-4 pt-8 border-t border-[var(--border)]">
        ...
        <div className="flex items-center justify-center gap-4">
          <Button onClick={onContactSupport} className="ff-btn-primary ff-hover-glow">
