    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4 ff-fade-in-up">
        ...
        <p className="ff-text-body max-w-3xl mx-auto">
          Complete implementation roadmap with discovery phase (weeks 1-2) and development phase
          (weeks 3-8) featuring comprehensive project management, resource allocation, and milestone
          tracking for successful platform deployment.
        </p>
      </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className="ff-badge-secondary text-xs">{component.phase}</Badge>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="ff-text-xs text-[var(--ff-text-muted)]">
                      Technical assessment & debt analysis
                    </div>
                  </div>
                </div>
      ...
      <Card className="ff-card border-[var(--ff-success)]/20">
        ...
        <CardContent className="space-y-6">
          <p className="ff-text-body">
            ...
            timelines, resource allocation, and milestone tracking for successful platform
            deployment from discovery to production launch.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="text-center p-4 bg-[var(--ff-surface)] rounded-lg">
              <div
                className="ff-text-2xl text-[var(--ff-accent)]"
                style={{ fontWeight: 'var(--ff-weight-bold)' }}
              >
                13
              </div>
