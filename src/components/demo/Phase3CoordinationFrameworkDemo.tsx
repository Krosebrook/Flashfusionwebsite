    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-4 ff-fade-in-up">
        ...
        <p className="ff-text-body max-w-3xl mx-auto">
          Complete implementation of design system synchronization and development workflow
          management with automated token export, component updates, and comprehensive sprint
          coordination.
        </p>
      </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="ff-text-xs text-[var(--ff-text-muted)]">
                      30+ variants with click-to-copy
                    </div>
                  </div>
                </div>
