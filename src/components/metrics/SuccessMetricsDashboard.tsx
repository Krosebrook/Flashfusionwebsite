    ...
    <Card className="ff-card">
      <CardContent className="p-6">
        ...
        <div className="space-y-3">
          <div
            className="ff-text-3xl text-[var(--ff-text-primary)]"
        ...
        {data.map((value: number, index: number) => {
          ...
          return (
            <div key={index} className="flex-1 flex flex-col items-center gap-1">
              ...
              />
              <div className="ff-text-xs text-[var(--ff-text-muted)]">{index + 1}</div>
            </div>
          );
        })}
      </div>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto">
            Comprehensive KPI dashboard tracking Monthly Active Users, conversion rates, Net
            Promoter Score, feature adoption, system uptime, API performance, and business
              ...
              <TabsContent value="growth" className="p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <Card className="ff-card">
                    ...
                    <CardContent className="space-y-4">
                      {Object.entries(successMetrics.conversion.funnel).map(
                        ([stage, count], index) => {
                  ...
                  <Card className="ff-card">
                    ...
                    <CardContent className="space-y-4">
                      {Object.entries(successMetrics.featureAdoption.features).map(
                        ([feature, rate]) => (
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <Progress
                              value={successMetrics.nps.breakdown.promoters}
                              className="h-2"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <Progress
                              value={successMetrics.nps.breakdown.passives}
                              className="h-2"
                            />
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex-1">
                            ...
                            <Progress
                              value={successMetrics.nps.breakdown.detractors}
                              className="h-2"
                            />
                          </div>
                        </div>
              ...
              <TabsContent value="reliability" className="p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  ...
                  <Card className="ff-card">
                    ...
                    <CardContent className="space-y-4">
                      {Object.entries(successMetrics.apiResponseTime.endpoints).map(
                        ([endpoint, time]) => (
                          <div key={endpoint} className="flex items-center justify-between">
                            ...
                            <div className="text-right">
                              ...
                              <div
                                className={`ff-text-xs ${time > 150 ? 'text-[var(--ff-warning)]' : 'text-[var(--ff-success)]'}`}
                              >
                                {time > 150 ? 'Slow' : 'Good'}
                              </div>
                            </div>
                  ...
                  <Card className="ff-card">
                    ...
                    <CardContent className="space-y-4">
                      {Object.entries(successMetrics.errorRate.categories).map(
                        ([category, rate]) => (
              ...
              <TabsContent value="performance" className="p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <Card className="ff-card">
                    ...
                    <CardContent className="space-y-4">
                      {Object.entries(successMetrics.performanceScore.metrics).map(
                        ([metric, score]) => (
