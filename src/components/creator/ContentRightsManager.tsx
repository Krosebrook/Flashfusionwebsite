...
export function ContentRightsManager() {
  ...
  const [activeTab, setActiveTab] = useState<'content' | 'templates' | 'compliance' | 'analytics'>(
    'content'
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button className="ff-btn-primary" onClick={() => setIsCreating(true)}>
                    ...
                    >
                      <div>
                        ...
                        <code className="text-xs text-gray-600">
                          {template || 'No disclosure required'}
                        </code>
                      </div>
                      <Button size="sm" variant="outline">
                        <Copy className="h-4 w-4" />
