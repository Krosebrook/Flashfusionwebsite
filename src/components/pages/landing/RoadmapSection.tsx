  ...
  return (
    <section className="py-20 bg-card/30">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-6 ff-text-gradient">Product Roadmap</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            See what's coming next for FlashFusion. We're constantly innovating to bring you the
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center ${item.color}`}
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    {item.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center space-x-2">
                        <CheckCircle
                          className={`w-4 h-4 ${item.status === 'completed' ? 'text-green-500' : 'text-muted-foreground'}`}
                        />
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">
            Your feedback shapes our roadmap. Let us know what features would help you build better
            applications.
          </p>
