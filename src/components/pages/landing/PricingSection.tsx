  ...
  const features = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          starter: '5 frameworks',
          pro: '10+ frameworks',
          enterprise: '15+ frameworks',
        },
        {
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Start free and scale as you grow. All plans include core AI tools, real outputs, and our
            gamification system.
          </p>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <Label
              htmlFor="billing"
              className={!isYearly ? 'font-semibold text-primary' : 'text-muted-foreground'}
            >
              Monthly
            </Label>
        ...
        >
          {plans.map((plan, index) => {
            ...
            const savingsPercent = isYearly
              ? savings[plan.name.toLowerCase() as keyof typeof savings]
              : 0;
            ...
            return (
              ...
              >
                ...
                <Card
                  className={`h-full ${plan.highlight ? 'ring-2 ring-primary shadow-xl ff-hover-glow' : 'ff-card-interactive'}`}
                >
        ...
        >
          <div className="text-center space-y-4">
            <h3 className="text-3xl font-bold ff-text-gradient">Compare All Features</h3>
            ...
            <CardContent className="p-12 text-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <h3 className="text-3xl font-bold ff-text-gradient">Enterprise-Grade Security</h3>
          ...
          <Card className="ff-card-interactive bg-green-500/5 border-green-500/20">
            <CardContent className="p-8">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                  Try FlashFusion risk-free for 30 days. If you're not completely satisfied with the
                  results, we'll refund every penny. No questions asked.
                </p>
