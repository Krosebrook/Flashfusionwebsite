  ...
  const testimonials = [
    {
      ...
      avatar: 'SC',
      quote:
        'FlashFusion reduced our development time by 70%. What used to take weeks now takes days. The AI tools are incredibly intuitive and the deployment process is seamless.',
    ...
    },
    {
      ...
      avatar: 'MR',
      quote:
        'As a non-technical founder, FlashFusion allowed me to build and deploy a functional MVP in just 3 days. The gamification aspect kept me motivated throughout the process.',
      project: 'SaaS MVP',
    ...
    },
    {
      ...
      avatar: 'EW',
      quote:
        "The 60+ AI tools cover everything I need. From UI design to API generation, it's like having a whole development team at my fingertips. Game-changer!",
    ...
    },
    {
      ...
      avatar: 'DP',
      quote:
        "We've deployed 50+ projects using FlashFusion. The consistency and quality are outstanding. Our team productivity has never been higher.",
    ...
    },
    {
      ...
      avatar: 'LT',
      quote:
        'FlashFusion transformed my freelance business. I can now take on 3x more projects while delivering higher quality work. The XP system makes coding addictive!',
    ...
    },
    {
      ...
      avatar: 'AH',
      quote:
        'The automated deployment to 8+ platforms saved us countless hours. The monitoring and analytics features give us insights we never had before.',
  ...
  return (
    <section className="py-20 bg-card/30">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold mb-6">Loved by Developers Worldwide</h2>
