        ...
        <Card className="text-center">
          <CardContent className="pt-6">
            <div className="text-2xl font-bold text-accent mb-1">
              {metrics.deployments.toLocaleString()}
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Your React projects could benefit from code splitting. This could reduce
                      initial bundle size by ~40%.
                    </p>
              ...
              <div className="p-4 bg-secondary/5 border border-secondary/20 rounded-lg">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Consider setting up automated deployments for your active projects to save 2+
                      hours weekly.
                    </p>
                    <Button size="sm" variant="outline" className="mt-2">
                      Setup Auto-Deploy
