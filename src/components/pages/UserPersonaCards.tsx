...
export function UserPersonaCards() {
    ...
    () => [
      {
        ...
        description:
          'Individual creators building personal brands and monetizing content across multiple platforms',
        avatar: '👨‍💻',
        color: {
        ...
        painPoints: [
          {
            ...
            description:
              'Spending 6-8 hours daily on content creation, editing, and publishing across multiple platforms',
            severity: 'critical',
            frequency: 'constant',
            impact: 9,
          ...
          },
          {
            ...
            description:
              'Lack of coding skills prevents implementing advanced features and integrations',
            severity: 'high',
            frequency: 'frequent',
            impact: 8,
          ...
          },
          {
            ...
            description:
              'Managing content across 5-10 different platforms with different requirements',
            severity: 'high',
            frequency: 'constant',
            impact: 8,
          ...
          },
          {
            ...
            description:
              'Difficulty identifying best monetization strategies and optimizing conversion rates',
            severity: 'medium',
            frequency: 'frequent',
            impact: 7,
          ...
          },
          {
            ...
            description:
              'Maintaining consistent branding and messaging across all content and platforms',
            severity: 'medium',
            frequency: 'frequent',
            impact: 6,
        ...
        workflow: [
          {
            ...
            description:
              'Brainstorming content ideas, researching trends, and planning content calendar',
          ...
          },
          {
            ...
            description:
              'Creating videos, writing, designing graphics, and producing multimedia content',
          ...
          },
          {
            ...
            description:
              'Publishing and scheduling content across all social media and content platforms',
            duration: '1-2 hours daily',
          ...
          },
          {
            ...
            description:
              'Managing sponsorships, affiliate marketing, product sales, and revenue streams',
            duration: '1-2 hours daily',
      ...
      },
      {
        ...
        description:
          'Small to medium development teams building applications and managing deployment workflows',
        avatar: '👥',
        color: {
        ...
        painPoints: [
          {
            ...
            description:
              'Time-consuming manual deployment processes with high error rates and rollback challenges',
            severity: 'critical',
            frequency: 'frequent',
            impact: 9,
          ...
          },
          {
            ...
            description:
              'Code conflicts, communication gaps, and coordination challenges across distributed team members',
            severity: 'high',
            frequency: 'frequent',
            impact: 8,
          ...
          },
          {
            ...
            description:
              'Varying code standards, insufficient testing, and technical debt accumulation',
            severity: 'high',
            frequency: 'frequent',
            impact: 8,
          ...
          },
          {
            ...
            description:
              'Difficulty tracking progress, managing deadlines, and coordinating multiple projects',
            severity: 'medium',
            frequency: 'frequent',
            impact: 7,
        ...
        devicePreferences: [
          {
            ...
            percentage: 70,
            context:
              'Primary development work, code review, complex debugging, system administration',
      ...
      },
      {
        ...
        description:
          'Enterprise-level organizations requiring scalable, secure, and compliant technology solutions',
        avatar: '🏢',
        color: {
        ...
        painPoints: [
          {
            ...
            description:
              'Concerns about system performance and scalability when serving millions of users',
            severity: 'critical',
            frequency: 'constant',
            impact: 10,
          ...
          },
          {
            ...
            description:
              'Meeting strict security standards, regulatory compliance, and audit requirements',
            severity: 'critical',
            frequency: 'constant',
            impact: 10,
          ...
          },
          {
            ...
            description:
              'Integrating with legacy systems, multiple databases, and existing enterprise software',
            severity: 'high',
            frequency: 'frequent',
            impact: 9,
          ...
          },
          {
            ...
            description:
              'Need for centralized control, user management, and policy enforcement across organization',
            severity: 'high',
            frequency: 'constant',
            impact: 8,
          ...
          },
          {
            ...
            description:
              'Justifying large technology investments and optimizing total cost of ownership',
            severity: 'medium',
            frequency: 'frequent',
            impact: 7,
        ...
        workflow: [
          {
            ...
            description:
              'Comprehensive evaluation of technology solutions, security assessment, and vendor analysis',
            duration: '2-6 months',
            tools: [
              'Security Scanner',
              'Compliance Checker',
          ...
          },
          {
            ...
            description:
              'Legal review, contract negotiation, compliance verification, and purchase approval',
            duration: '1-3 months',
            tools: [
              'Contract Management',
          ...
          },
          {
            ...
            description:
              'System deployment, legacy integration, user migration, and configuration management',
          ...
          },
          {
            ...
            description:
              'Staff training, change management, user onboarding, and adoption measurement',
            duration: '2-6 months',
          ...
          },
          {
            ...
            description:
              'Daily operations, user management, policy enforcement, and system administration',
            duration: 'Ongoing',
          ...
          },
          {
            ...
            description:
              'Performance monitoring, cost analysis, ROI measurement, and continuous improvement',
            duration: 'Ongoing',
            tools: [
        ...
        devicePreferences: [
          {
            ...
            percentage: 50,
            context:
              'Administrative work, detailed analysis, system configuration, strategic planning',
  ...
  return (
    <div
      className="min-h-screen bg-[var(--ff-bg-dark)] p-6"
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto">
            Comprehensive user persona analysis mapping every FlashFusion feature to specific user
            needs, workflows, and success metrics across three primary user segments.
          </p>
        </div>
            ...
            <div className="relative z-10 grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm">
                  <div>
                    <strong>Age:</strong> {selectedPersonaData.demographics.age}
                  </div>
                  <div>
                    <strong>Experience:</strong> {selectedPersonaData.demographics.experience}
                  </div>
                  <div>
                    <strong>Team Size:</strong> {selectedPersonaData.demographics.teamSize}
                  </div>
                  <div>
                    <strong>Budget:</strong> {selectedPersonaData.demographics.budget}
                  </div>
                  <div>
                    <strong>Industries:</strong>{' '}
                    {selectedPersonaData.demographics.industry.join(', ')}
                  </div>
                </div>
              </div>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="space-y-2">
                            ...
                            <div className="flex gap-2">
                              <Badge
                                variant={getSeverityColor(painPoint.severity)}
                                className="text-xs"
                              >
                                {painPoint.severity}
                              </Badge>
                      ...
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <Badge
                              variant={step.automation ? 'default' : 'outline'}
                              className="text-xs"
                            >
                              ...
                              <div>
                                ...
                                <div className="flex flex-wrap gap-1">
                                  {step.painPoints.map((painPointId) => {
                                    const painPoint = selectedPersonaData.painPoints.find(
                                      (p) => p.id === painPointId
                                    );
                                    return painPoint ? (
                                      <Badge
                      ...
                      <CardHeader>
                        <div className="flex items-center justify-between">
                          <CardTitle className="flex items-center gap-2">
                            <Zap
                              className="w-5 h-5"
                              style={{ color: selectedPersonaData.color.primary }}
                            />
                            {category.category}
                          </CardTitle>
                      ...
                      <CardContent className="space-y-4">
                        <div className="grid md:grid-cols-2 gap-4">
                          <div>
                            ...
                            <div className="text-sm text-[var(--ff-text-muted)]">
                              Usage Rate: {category.usage}%
                            </div>
                          </div>
                          <div>
                            <Progress value={category.satisfaction * 10} className="h-3 mb-2" />
                            <div className="text-sm text-[var(--ff-text-muted)]">
                              Satisfaction: {category.satisfaction}/10
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-2">
                            {category.features.map((feature) => (
                              <div
                                key={feature}
                                className="flex items-center gap-2 p-2 bg-[var(--ff-surface)] rounded-lg"
                              >
                            ...
                            <div key={device.device} className="space-y-3">
                              ...
                              {device.limitations && (
                                <div className="ml-9 space-y-1">
                                  <h4 className="text-sm font-medium text-[var(--ff-text-muted)]">
                                    Limitations:
                                  </h4>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-[var(--ff-text-muted)]">
                  {selectedPersonaData.successMetrics.find((m) => m.priority === 'critical')
                    ?.name || selectedPersonaData.successMetrics[0]?.name}
                </p>
              </div>
            </div>
          </CardContent>
