    ...
    () => [
      ...
      },
      {
        ...
        features: [
          ...
          {
            name: 'All platforms + custom integrations',
            included: true,
          ...
          {
            name: 'Full white-label solution',
            included: true,
    ...
    >
      ...
      <div className="fixed top-4 right-4 z-50 bg-[var(--ff-surface)] border border-[var(--border)] rounded-lg p-4 text-xs ff-text-caption opacity-75 hover:opacity-100 transition-opacity">
        <div className="space-y-2 min-w-[200px]">
          <div className="ff-text-sm font-semibold text-[var(--ff-text-primary)] mb-2">
            📊 Live Metrics
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div>
              Views: <span className="text-[var(--ff-primary)]">{conversionMetrics.pageViews}</span>
            </div>
            <div>
              Visitors:{' '}
              <span className="text-[var(--ff-secondary)]">{conversionMetrics.uniqueVisitors}</span>
            </div>
            <div>
              Conv Rate:{' '}
              <span className="text-[var(--ff-success)]">{conversionMetrics.conversionRate}%</span>
            </div>
            <div>
              Bounce:{' '}
              <span className="text-[var(--ff-warning)]">{conversionMetrics.bounceRate}%</span>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16 ff-fade-in-up">
          ...
          <p className="ff-text-body max-w-3xl mx-auto mb-8">
            Transform your creative workflow with FlashFusion's AI-powered platform. Start free,
            scale seamlessly, and unlock unlimited potential.
          </p>

          {/* Billing Toggle */}
          <div className="flex items-center justify-center gap-4 mb-8">
            <span
              className={`ff-text-sm ${!isYearly ? 'text-[var(--ff-text-primary)]' : 'text-[var(--ff-text-muted)]'}`}
            >
              Monthly
            </span>
            <Switch checked={isYearly} onCheckedChange={setIsYearly} className="ff-focus-ring" />
            <span
              className={`ff-text-sm ${isYearly ? 'text-[var(--ff-text-primary)]' : 'text-[var(--ff-text-muted)]'}`}
            >
              Yearly
              ...
              <CardHeader className="text-center pb-8">
                ...
                <div className="space-y-2">
                  <div className="flex items-baseline justify-center">
                    <span
                      className="ff-text-5xl text-[var(--ff-text-primary)]"
                      style={{
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 p-8 bg-[var(--ff-surface)] border border-[var(--border)] rounded-lg">
            ...
            <p className="ff-text-body mb-6">
              Talk to our sales team about enterprise pricing, custom integrations, and volume
              discounts.
            </p>
