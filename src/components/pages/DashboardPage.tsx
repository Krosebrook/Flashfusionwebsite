        ...
        <TabsContent value="projects" className="space-y-6">
          <Card className="ff-card">
            <CardHeader>
              ...
              <CardDescription>Manage and track all your FlashFusion projects</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                {recentProjects.map((project) => (
                  ...
                  >
                    <div className="flex-1 space-y-2">
                      ...
                      <p className="ff-text-sm text-muted-foreground">{project.description}</p>
        ...
        <TabsContent value="activity" className="space-y-6">
          <Card className="ff-card">
            <CardHeader>
              ...
              <CardDescription>Your latest actions and updates across FlashFusion</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {recentActivity.map((activity) => (
                  ...
                  >
                    ...
                    <div className="flex-1 space-y-1">
                      ...
                      <p className="ff-text-sm text-muted-foreground">{activity.description}</p>
                      <p className="ff-text-xs text-muted-foreground">{activity.timestamp}</p>
                    </div>
                    {activity.status && (
                      <Badge
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <Card className="ff-card">
              <CardHeader>
                ...
                <CardDescription>Your FlashFusion usage over time</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
