      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold ff-text-gradient">Full-Stack App Builder</h1>
          </div>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Experience the power of AI-driven full-stack application generation. Build complete web
            applications with frontend, backend, database, and deployment configurations in minutes.
          </p>

          <Alert className="max-w-2xl mx-auto">
            <CheckCircle className="h-4 w-4" />
            <AlertDescription>
              <strong>✅ STEP 1 COMPLETE:</strong> Full-Stack App Builder is now fully functional
              with real AI generation, working downloads, gamification integration, and complete
              file structures!
            </AlertDescription>
          </Alert>
        ...
        <Tabs value={activeDemo} onValueChange={(value) => setActiveDemo(value as any)}>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Uses your configured AI models (OpenAI, Anthropic, etc.) to generate
                          actual production-ready code
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          Generates frontend, backend, database schemas, Docker configs, and
                          documentation
                        </p>
                      </div>
                    </div>
              ...
              <Card className="ff-card-interactive">
                ...
                <CardContent className="space-y-4">
                  <p className="text-muted-foreground">
                    Ready to see the Full-Stack App Builder in action? Click below to start
                  ...
                  <div className="space-y-3">
                    ...
                    <Button onClick={handleTestXP} variant="outline" className="w-full">
                  ...
                  <Alert>
                    ...
                    <AlertDescription>
                      <strong>Tip:</strong> Make sure you have an AI model configured in Settings →
                      AI Configuration for the best experience.
                    </AlertDescription>
                  </Alert>
                </CardContent>
              </Card>
          ...
          <TabsContent value="builder" className="space-y-6">
            <Card className="ff-card-interactive">
              <CardHeader>
                <CardTitle className="ff-text-gradient">🚀 Live Full-Stack App Builder</CardTitle>
                <p className="text-muted-foreground">
