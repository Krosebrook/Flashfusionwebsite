...
export function MobileOptimizationCenter() {
  ...
  const criticalIssues = accessibilityChecks.filter(
    (check) => check.status === 'fail' && (check.impact === 'critical' || check.impact === 'high')
  ).length;
    ...
    <div className="space-y-6 ff-fade-in-up">
        ...
        <div className="flex items-center gap-3">
          {deviceMetrics && (
            <div className="flex items-center gap-2">
              {deviceMetrics.device === 'mobile' ? (
                <Smartphone className="h-5 w-5" />
              ) : deviceMetrics.device === 'tablet' ? (
      ...
      {criticalIssues > 0 && (
        <Alert className="border-destructive bg-destructive/5">
          ...
          <AlertDescription>
            {criticalIssues} critical accessibility or mobile usability issue
            {criticalIssues === 1 ? '' : 's'} found.
            <Button
              size="sm"
              variant="destructive"
              className="ml-3"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="ff-card-interactive">
            <CardContent className="p-6">
              ...
              <p
                className={`text-2xl font-bold ${getScoreColor(mobileOptimization.touchTargets.compliance)}`}
              >
          ...
          <Card className="ff-card-interactive">
            <CardContent className="p-6">
              ...
              <p
                className={`text-2xl font-bold ${getScoreColor(mobileOptimization.textReadability.score)}`}
              >
          ...
          <Card className="ff-card-interactive">
            <CardContent className="p-6">
              ...
              <p
                className={`text-2xl font-bold ${getScoreColor(mobileOptimization.userExperience.score)}`}
              >
      ...
      <Tabs defaultValue="responsive" className="space-y-4">
        <TabsList className="grid w-full grid-cols-4">
          ...
          <TabsTrigger value="accessibility" className="ff-focus-ring">
            Accessibility ({accessibilityChecks.filter((c) => c.status === 'pass').length}/
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className={getImpactColor(check.impact)}>{check.impact}</Badge>
                        </div>
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.firstContentfulPaint < 1800 ? 90 : 60)}`}
                      >
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.largestContentfulPaint < 2500 ? 85 : 55)}`}
                      >
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.firstInputDelay < 100 ? 95 : 70)}`}
                      >
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.cumulativeLayoutShift < 0.1 ? 90 : 60)}`}
                      >
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.timeToInteractive < 3800 ? 85 : 60)}`}
                      >
                ...
                <Card className="ff-card-interactive">
                  <CardContent className="p-6">
                    <div className="space-y-3">
                      ...
                      <p
                        className={`text-2xl font-bold ${getScoreColor(performanceScore.speedIndex < 3400 ? 80 : 55)}`}
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3 p-3 bg-yellow-500/5 rounded-lg">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">
                          Implement lazy loading for better initial load
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {mobileOptimization.touchTargets.minSize}px
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Spacing</span>
                        <span className="font-medium">
                          {mobileOptimization.touchTargets.spacing}px
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Compliance</span>
                        <span
                          className={`font-medium ${getScoreColor(mobileOptimization.touchTargets.compliance)}`}
                        >
                          {mobileOptimization.touchTargets.compliance.toFixed(0)}%
                        </span>
                      </div>
                      <Progress
                        value={mobileOptimization.touchTargets.compliance}
                        className="h-2"
                      />
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {mobileOptimization.textReadability.fontSize}px
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Contrast Ratio</span>
                        <span className="font-medium">
                          {mobileOptimization.textReadability.contrast.toFixed(1)}:1
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Line Height</span>
                        <span className="font-medium">
                          {mobileOptimization.textReadability.lineHeight}
                        </span>
                      </div>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {mobileOptimization.loadingPerformance.bundleSize.toFixed(0)}KB
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Image Optimization</span>
                        <span className="font-medium">
                          {mobileOptimization.loadingPerformance.imageOptimization.toFixed(0)}%
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Cache Hit Rate</span>
                        <span className="font-medium">
                          {mobileOptimization.loadingPerformance.cacheHitRate.toFixed(0)}%
                        </span>
                      </div>
                      <Progress
                        value={mobileOptimization.loadingPerformance.score}
                        className="h-2"
                      />
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">
                          {mobileOptimization.userExperience.scrollPerformance.toFixed(0)}%
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Navigation Ease</span>
                        <span className="font-medium">
                          {mobileOptimization.userExperience.navigationEase.toFixed(0)}%
                        </span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm text-muted-foreground">Content Accessibility</span>
                        <span className="font-medium">
                          {mobileOptimization.userExperience.contentAccessibility.toFixed(0)}%
                        </span>
                      </div>
