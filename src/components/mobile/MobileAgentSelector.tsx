...
const MOBILE_AGENTS: MobileAgent[] = [
  {
    ...
    type: 'researcher',
    description:
      'Analyzes trends, markets, and user behavior to provide data-driven insights for strategic decisions',
  ...
  },
  {
    ...
    type: 'creator',
    description:
      'Generates high-quality content, designs, and creative assets across multiple formats and platforms',
  ...
  },
  {
    ...
    type: 'optimizer',
    description:
      'Enhances performance, conversions, and operational efficiency through data-driven optimization',
  ...
  },
  {
    ...
    type: 'automator',
    description:
      'Streamlines workflows and automates repetitive business processes for maximum efficiency',
  ...
  },
  {
    ...
    type: 'analyzer',
    description:
      'Processes complex data and generates actionable business intelligence with detailed insights',
  ...
  },
  {
    ...
    type: 'orchestrator',
    description:
      'Coordinates multi-agent workflows and manages complex operations across the entire platform',
      ...
      <div className="flex items-center justify-between mb-6 pt-2">
        ...
        <div className="flex items-center space-x-2">
          <Badge
            ...
            style={{
              backgroundColor: `${currentAgent.accentColor}20`,
              border: `1px solid ${currentAgent.accentColor}`,
            }}
          >
            {currentAgent.type}
          </Badge>
      ...
      <div className="flex justify-center space-x-2 mb-6">
        {MOBILE_AGENTS.map((_, index) => (
          <button
            ...
            style={{
              backgroundColor:
                index === currentIndex ? currentAgent.accentColor : 'rgba(255, 255, 255, 0.3)',
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="text-center p-3 bg-gray-50 rounded-xl">
                  <div className="text-xl font-bold" style={{ color: currentAgent.accentColor }}>
              ...
              <div className="mb-6 p-3 bg-blue-50 rounded-xl">
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-blue-600 mt-1">{currentAgent.recentActivity}</div>
                  </div>
                </div>
              </div>
