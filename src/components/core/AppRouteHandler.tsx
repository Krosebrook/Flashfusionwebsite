...
const FlashFusionInterface = createLazyComponent(() => import('./flash-fusion-interface'), {
...
const TryDemoInterface = createLazyComponent(() => import('../demo/TryDemoInterface'), {
...
export const AppRouteHandler: React.FC<AppRouteHandlerProps> = React.memo(
  ({ appState, performanceMetrics, systemInfo, authState, authActions, computed }) => {
    ...
    if (isDemoMode) {
      return (
        ...
        >
          <div
            className="ff-page-transition min-h-screen bg-[var(--ff-bg-dark)]"
