  ...
  const runSecurityScan = async () => {
    ...
    setSecurityMetrics((prev) => ({
      ...
      overallSecurityScore: Math.min(
        100,
        prev.overallSecurityScore + Math.floor(Math.random() * 4) - 1
      ),
    }));
    ...
    <div className="max-w-6xl mx-auto p-6 space-y-8">
      ...
      >
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          Advanced security validation for third-party integrations with automated sandboxing,
          vulnerability detection, and API rate limiting.
        </p>
      </motion.div>
      ...
      >
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <div className="w-16 h-16 rounded-full border-4 border-primary/20 flex items-center justify-center">
                  <span
                    className={`text-2xl font-bold ${getScoreColor(securityMetrics.overallSecurityScore)}`}
                  >
        ...
        <Card className="ff-card-interactive">
          <CardContent className="p-6">
            ...
            <div className="mt-2">
              <Badge
                variant={securityMetrics.criticalVulnerabilities === 0 ? 'outline' : 'destructive'}
              >
                        ...
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                              ...
                              <Badge
                                className={
                                  plugin.securityScore >= 90
                                    ? 'bg-green-500/10 text-green-500 border-green-500/20'
                                    : plugin.securityScore >= 80
                            ...
                            <p className="text-sm text-muted-foreground mb-3">
                              By {plugin.developer} • Installed {plugin.installDate} • Last scan:{' '}
                              {plugin.lastScan}
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                              <div className="space-y-1">
                                ...
                                <div className="flex items-center space-x-2">
                                  <Progress
                                    value={
                                      (plugin.rateLimit.current / plugin.rateLimit.limit) * 100
                                    }
                            ...
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                ...
                                <p className="font-medium">
                                  {config.networkAccess ? 'Allowed' : 'Blocked'}
                                </p>
                              </div>
                              <div>
                                <span className="text-muted-foreground">File System:</span>
                                <p className="font-medium">
                                  {config.fileSystemAccess ? 'Allowed' : 'Blocked'}
                                </p>
                              </div>
                              <div>
