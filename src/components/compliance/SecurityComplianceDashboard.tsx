...
const complianceFrameworks = {
    ...
    categories: {
      security: {
        ...
        tasks: [
          ...
          {
            id: 'sec-2',
            name: 'Access control policy documentation',
            completed: true,
            priority: 'high',
      ...
      availability: {
        ...
        tasks: [
          ...
          {
            id: 'avail-4',
            name: 'Capacity planning documentation',
            completed: false,
            priority: 'medium',
  ...
  gdpr: {
    ...
    requirements: [
      ...
      {
        id: 'gdpr-2',
        name: 'Data subject consent mechanisms',
        completed: true,
        priority: 'critical',
        category: 'Consent',
      },
      {
        id: 'gdpr-3',
        name: 'Right to access implementation',
        completed: true,
        priority: 'high',
        category: 'Rights',
      },
      {
        id: 'gdpr-4',
        name: 'Right to rectification procedures',
        completed: true,
        priority: 'high',
        category: 'Rights',
      },
      ...
      {
        id: 'gdpr-7',
        name: 'Right to object mechanisms',
        completed: true,
        priority: 'medium',
        category: 'Rights',
      },
    ...
    safeguards: {
      ...
      physical: {
        ...
        requirements: [
          ...
          {
            id: 'hipaa-phys-2',
            name: 'Workstation use restrictions',
            completed: true,
            priority: 'required',
          },
          {
          ...
          {
            id: 'hipaa-phys-4',
            name: 'Equipment disposal procedures',
            completed: true,
      ...
      technical: {
        ...
        requirements: [
          ...
          {
            id: 'hipaa-tech-2',
            name: 'Audit controls implementation',
            completed: true,
            priority: 'required',
          },
          {
  ...
  responseTeam: [
    {
      ...
      name: 'Sarah Chen',
      contact: 'sarah.chen@flashfusion.ai',
      status: 'available',
    },
    {
      role: 'Security Lead',
      name: 'Marcus Rodriguez',
      contact: 'marcus.r@flashfusion.ai',
      status: 'available',
    },
    {
      role: 'Technical Lead',
      name: 'Aisha Patel',
      contact: 'aisha.patel@flashfusion.ai',
      status: 'on-call',
    },
    {
      role: 'Communications Lead',
      name: 'David Kim',
      contact: 'david.kim@flashfusion.ai',
      status: 'available',
    },
  ],
  procedures: [
    ...
    },
    {
      ...
      status: 'manual',
      description: 'Incident classification and assessment',
    },
    {
      phase: 'Containment',
      duration: '15-30 minutes',
      status: 'manual',
      description: 'Immediate threat containment',
    },
    {
      phase: 'Investigation',
      duration: '30+ minutes',
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <Badge className="ff-badge-success">{overallScore.toFixed(1)}% Overall Score</Badge>
                  ...
                  <Card key={key} className="ff-card">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <StatusIcon
                          className="w-5 h-5"
                          style={{ color: getStatusColor(framework.status) }}
                        />
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <Badge
                          className={`ff-badge-${framework.status === 'compliant' ? 'success' : framework.status === 'in-progress' ? 'warning' : 'error'} w-full justify-center`}
                        >
            ...
            <Tabs value={selectedFramework} onValueChange={setSelectedFramework} className="w-full">
              ...
              <TabsContent value="soc2" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-warning">87.5% Complete</Badge>
                </div>
                    ...
                    <Card key={key} className="ff-card">
                      ...
                      <CardContent className="space-y-3">
                        {category.tasks.map((task) => (
                          <div
                            key={task.id}
                            className="flex items-center gap-3 p-3 bg-[var(--ff-surface-light)] rounded-lg"
                          >
                            <Checkbox checked={task.completed} className="flex-shrink-0" />
                            <div className="flex-1">
              ...
              <TabsContent value="gdpr" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">91.2% Compliant</Badge>
                </div>
                ...
                <div className="space-y-3">
                  {complianceFrameworks.gdpr.requirements.map((requirement) => (
                    <div
                      key={requirement.id}
                      className="flex items-center gap-3 p-4 bg-[var(--ff-surface)] rounded-lg border border-[var(--border)]"
                    >
                      <Checkbox checked={requirement.completed} className="flex-shrink-0" />
                      <div className="flex-1">
                        <div
                          className="ff-text-sm text-[var(--ff-text-primary)]"
                          style={{ fontWeight: 'var(--ff-weight-semibold)' }}
              ...
              <TabsContent value="hipaa" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-warning">85.7% Complete</Badge>
                </div>
              ...
              <TabsContent value="ccpa" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">89.3% Compliant</Badge>
                </div>
                ...
                <div className="space-y-3">
                  {complianceFrameworks.ccpa.consumerRights.map((right) => (
                    <div
                      ...
                      className="flex items-center gap-3 p-4 bg-[var(--ff-surface)] rounded-lg border border-[var(--border)]"
                    >
                      <Checkbox checked={right.completed} className="flex-shrink-0" />
                      <div className="flex-1">
                        <div
                          className="ff-text-sm text-[var(--ff-text-primary)]"
                          style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                      ...
                      <Badge className="ff-badge-error">{right.priority}</Badge>
                      {right.completed ? (
                        <CheckCircle className="w-5 h-5 text-[var(--ff-success)]" />
                      ) : (
                        <Clock className="w-5 h-5 text-[var(--ff-warning)]" />
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-3">
                {encryptionStatus.atRest.systems.map((system, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-3 bg-[var(--ff-surface-light)] rounded-lg"
                  >
                    <div className="flex items-center gap-2">
              ...
              <div className="space-y-3">
                {encryptionStatus.inTransit.endpoints.map((endpoint, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Badge className="ff-badge-success">{endpoint.method}</Badge>
                      <CheckCircle className="w-4 h-4 text-[var(--ff-success)]" />
                    </div>
                  </div>
                ))}
        ...
        <Card className="ff-card">
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-[var(--ff-surface)] rounded-lg">
                <div
                  className="ff-text-2xl text-[var(--ff-primary)]"
                  style={{ fontWeight: 'var(--ff-weight-bold)' }}
                >
              ...
              {consentManagement.consentTypes.map((type, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full ${type.required ? 'bg-[var(--ff-error)]' : 'bg-[var(--ff-success)]'}`}
                    ></div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                {auditLogRetention.categories.map((category, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-2 bg-[var(--ff-surface-light)] rounded"
                  >
                    <span className="ff-text-sm text-[var(--ff-text-primary)]">
                      {category.category}
                    </span>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-3 bg-[var(--ff-surface)] rounded-lg">
                  <div className="flex items-center justify-center gap-2 mb-1">
                    ...
                    <span
                      className="ff-text-sm text-[var(--ff-success)]"
                      style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                    >
              ...
              <div className="space-y-2">
                ...
                {incidentResponse.recentIncidents.slice(0, 3).map((incident, index) => (
                  ...
                  >
                    <div>
                      <div className="ff-text-xs text-[var(--ff-text-primary)]">
                        {incident.type}
                      </div>
                    ...
                    <div className="text-right">
                      <Badge
                        className={`ff-badge-${incident.severity === 'high' ? 'error' : incident.severity === 'medium' ? 'warning' : 'secondary'} text-xs`}
                      >
                        {incident.severity}
                      </Badge>
                      <div className="ff-text-xs text-[var(--ff-text-muted)] mt-1">
