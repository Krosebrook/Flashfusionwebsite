...
const blindspotCategories = {
  'technical-debt': {
    ...
    description:
      'Accumulated shortcuts, outdated code, and architectural issues that slow development',
    riskLevel: 'high',
    blindspots: [
      {
        id: 'legacy-code',
        ...
        description:
          'Outdated libraries and deprecated dependencies affecting security and performance',
        impact: 8,
        probability: 7,
        severity: 'critical',
        ...
        businessImpact:
          'Slower feature development, increased maintenance costs, security vulnerabilities',
      ...
      },
      {
        ...
        businessImpact:
          'Limited scalability, increased infrastructure costs, system reliability issues',
        mitigationStrategies: [
    ...
    blindspots: [
      {
        ...
        businessImpact:
          'User frustration, increased churn, potential revenue loss during traffic spikes',
        mitigationStrategies: [
      ...
      },
      {
        ...
        businessImpact:
          'Slow application performance, poor user experience, increased infrastructure costs',
        mitigationStrategies: [
    ...
    blindspots: [
      {
        ...
        businessImpact:
          'Data breaches, legal liability, loss of user trust and business reputation',
        mitigationStrategies: [
  ...
  'market-competition': {
    ...
    blindspots: [
      ...
      },
      {
        ...
        businessImpact:
          'Suboptimal revenue, customer acquisition challenges, competitive disadvantage',
        mitigationStrategies: [
...
export function CommonBlindspotsMatrix({}: CommonBlindspotsMatrixProps) {
  ...
  const riskMetrics = useMemo(() => {
    ...
    const avgProbability =
      allBlindspots.reduce((sum, b) => sum + b.probability, 0) / totalBlindspots;
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4 ff-fade-in-up">
          ...
          <h1 className="ff-text-display">
            Risk Matrix &<span className="ff-text-gradient"> Solutions</span>
          </h1>

          <p className="ff-text-body max-w-3xl mx-auto">
            Comprehensive risk matrix board categorizing blindspots such as Technical Debt, User
            Experience Gaps, Performance Under Load, Security Vulnerabilities, and Market
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span
                          ...
                          style={{ fontWeight: 'var(--ff-weight-semibold)' }}
                        >
                          {mitigationProgress[key as keyof typeof mitigationProgress]?.progress ||
                            0}
                          %
                        </span>
                      </div>
              ...
              <Card className="ff-card">
                <CardHeader>
                  <CardTitle className="ff-text-title flex items-center gap-2">
                    ...
                    {
                      blindspotCategories[selectedCategory as keyof typeof blindspotCategories].name
                    }{' '}
                    - Detailed Analysis
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-6">
                  {blindspotCategories[
                    selectedCategory as keyof typeof blindspotCategories
                      ...
                      <Card
                        ...
                        onClick={() =>
                          setSelectedBlindspot(
                            selectedBlindspot === blindspot.id ? null : blindspot.id
                          )
                        }
                      >
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-3">
                                <div className="text-center p-2 bg-[var(--ff-surface)] rounded">
                                  <div
                                    className="ff-text-lg text-[var(--ff-error)]"
                                    style={{ fontWeight: 'var(--ff-weight-bold)' }}
                                  >
                                    {blindspot.impact}
                                  </div>
                                ...
                                <div className="text-center p-2 bg-[var(--ff-surface)] rounded">
                                  <div
                                    className="ff-text-lg text-[var(--ff-warning)]"
                                    style={{ fontWeight: 'var(--ff-weight-bold)' }}
                                  >
                                ...
                                <div className="text-center p-2 bg-[var(--ff-surface)] rounded">
                                  <div
                                    className="ff-text-lg text-[var(--ff-accent)]"
                                    style={{ fontWeight: 'var(--ff-weight-bold)' }}
                                  >
                                    {riskScore}
                                  </div>
                                ...
                                <div className="text-center p-2 bg-[var(--ff-surface)] rounded">
                                  <StatusIcon
                                    ...
                                    style={{ color: getStatusColor(blindspot.status) }}
                                  />
                              ...
                              <div>
                                ...
                                <ul className="mt-2 space-y-2">
                                  {blindspot.mitigationStrategies.map((strategy, index) => (
                                    <li
                                      key={index}
                                      className="ff-text-sm text-[var(--ff-text-secondary)] flex items-start gap-2"
                                    >
