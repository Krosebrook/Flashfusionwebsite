...
const SAMPLE_FLOWS: AutomationFlow[] = [
  {
    ...
    description:
      'Automated workflow for creating, optimizing, and publishing content across multiple platforms',
    isActive: true,
    ...
    const newNode: FlowNode = {
      ...
      data: {
        ...
        agentColor: agentType
          ? AGENT_TYPES[agentType as keyof typeof AGENT_TYPES].color
          : undefined,
      ...
      >
        ...
        >
          ...
          <div className="p-4">
            ...
            <p className="text-xs text-gray-600 mb-3 leading-relaxed">{node.data.description}</p>
