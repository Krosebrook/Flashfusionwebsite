    ...
    <Card className="ff-card">
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge
            className={`ff-badge-${status === 'excellent' ? 'success' : status === 'good' ? 'secondary' : 'warning'}`}
          >
            {status}
          </Badge>
        </div>
        ...
        <div className="flex items-center justify-between">
          <div className="text-center">
            ...
            <div
              className="ff-text-lg text-[var(--ff-text-secondary)]"
              style={{ fontWeight: 'var(--ff-weight-semibold)' }}
            >
              {target}
              {unit}
          ...
          <div className="flex items-center gap-1">
            ...
            <span
              className={`ff-text-sm ${trend > 0 ? 'text-[var(--ff-success)]' : 'text-[var(--ff-error)]'}`}
            >
            ...
            <Tabs defaultValue="accessibility" className="w-full">
              ...
              <TabsContent value="accessibility" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">96.8% Compliant</Badge>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {qualityMetrics.accessibility.issues.map((issue, index) => (
                    <div
                      key={index}
                      className="flex items-start gap-3 p-3 bg-[var(--ff-surface-light)] rounded-lg"
                    >
                      <AlertTriangle
                        className={`w-4 h-4 mt-0.5 ${issue.type === 'minor' ? 'text-[var(--ff-warning)]' : 'text-[var(--ff-error)]'}`}
                      />
              ...
              <TabsContent value="performance" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">2.1s Load Time</Badge>
                </div>
              ...
              <TabsContent value="consistency" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">98.7% Consistent</Badge>
                </div>

                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
                  {Object.entries(qualityMetrics.visualConsistency.components).map(
                    ([key, value]) => (
                      <div key={key} className="p-4 bg-[var(--ff-surface)] rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <span
                ...
                <div className="space-y-3">
                  ...
                  {qualityMetrics.visualConsistency.violations.map((violation, index) => (
                    ...
                    >
                      <Code
                        className={`w-4 h-4 mt-0.5 ${violation.severity === 'low' ? 'text-[var(--ff-warning)]' : 'text-[var(--ff-error)]'}`}
                      />
                      <div className="flex-1">
                        <div className="ff-text-sm text-[var(--ff-text-primary)]">
                          <span style={{ fontWeight: 'var(--ff-weight-semibold)' }}>
                            {violation.component}:
                          </span>{' '}
                          {violation.issue}
                        </div>
              ...
              <TabsContent value="mobile" className="p-6 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="ff-badge-success">1.7s Load Time</Badge>
                </div>
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {Object.entries(qualityMetrics.mobileOptimization.optimizations).map(
                      ([key, value]) => (
                        <div key={key} className="p-4 bg-[var(--ff-surface)] rounded-lg">
                          <div className="flex items-center justify-between mb-2">
                            <span
                  ...
                  <div key={gate.id} className="p-4 bg-[var(--ff-surface)] rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge
                          className={`ff-badge-${gate.status === 'passed' ? 'success' : gate.status === 'warning' ? 'warning' : 'error'}`}
                        >
                          {gate.status}
                        </Badge>
                      </div>
