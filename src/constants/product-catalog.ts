...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    description:
      'Inspire yourself and others with this powerful motivational design. Perfect for entrepreneurs, students, and anyone pursuing their dreams. Premium cotton blend for comfort and durability.',
    ...
    seo: {
      ...
      metaDescription:
        'Inspire yourself with this premium motivational t-shirt. High-quality cotton, comfortable fit, perfect for entrepreneurs and dreamers.',
  ...
  },
  {
    ...
    description:
      'Modern minimalist poster featuring bold geometric shapes in vibrant colors. Perfect for contemporary home or office decoration. High-quality print on premium paper.',
    category: 'abstract',
    productType: 'poster',
    basePrice: 8.99,
    ...
    seo: {
      ...
      metaDescription:
        'Transform your space with this stunning abstract geometric poster. Modern minimalist design, high-quality print, multiple sizes available.',
  ...
  },
  {
    ...
    description:
      'Cozy hoodie featuring an authentic vintage-style badge design. Perfect for casual wear with a classic, timeless appeal. Soft fleece interior for warmth and comfort.',
    category: 'vintage',
    productType: 'hoodie',
    basePrice: 24.99,
    ...
    seo: {
      ...
      metaDescription:
        'Stay cozy in style with this vintage badge hoodie. Authentic retro design, premium fleece material, perfect for casual wear.',
