...
export const createBadges = (userRole?: string): Badge[] => [
  {
    id: '1',
    name: 'React Rookie',
    description: 'Generated your first React app',
    icon: '⚛️',
    color: '#FF7B00',
    earned: true,
  ...
  },
  {
    id: '2',
    name: 'Platform Pro',
    description: 'Created apps on 3+ platforms',
    icon: '🚀',
    color: '#00B4D8',
    earned: true,
  ...
  {
    id: '3',
    name: 'Validator Veteran',
    description: 'Validated 10+ app ideas',
    icon: '✅',
    color: '#E91E63',
    earned: userRole === 'pro',
  },
  {
    id: '4',
    name: 'Code Crusader',
    description: 'Generated 100+ code snippets',
    icon: '⚡',
    color: '#FF7B00',
    earned: true,
  ...
  },
  {
    id: '5',
    name: 'Design Dynamo',
    description: 'Created 50+ images with AI',
    icon: '🎨',
    color: '#00B4D8',
    earned: true,
  ...
  },
  {
    id: '6',
    name: 'Remix Master',
    description: 'Remixed 25+ templates',
    icon: '🔄',
    color: '#E91E63',
    earned: userRole === 'pro',
  },
  {
    id: '7',
    name: 'Speed Demon',
    description: 'Built an app in under 5 minutes',
    icon: '💨',
    color: '#FF7B00',
    earned: userRole === 'pro',
  },
  {
    ...
    description: 'Shared 10+ templates publicly',
    icon: '👥',
    color: '#00B4D8',
    earned: userRole === 'pro',
  },
  ...
  },
  {
    id: '10',
    name: 'Deploy Master',
    description: 'Deployed to 5+ platforms',
    icon: '🚀',
    color: '#FF7B00',
    earned: userRole === 'pro',
  },
  {
    ...
    description: 'Connected 10+ services',
    icon: '🔗',
    color: '#00B4D8',
    earned: userRole === 'pro',
  },
  {
    id: '12',
    name: 'Analytics Guru',
    description: 'Set up advanced analytics',
    icon: '📊',
    color: '#E91E63',
    earned: userRole === 'pro',
  },
...
export const dailyTasks: DailyTask[] = [
  {
    ...
    description: 'Start a new project using the wizard',
    xpReward: 100,
    completed: true,
    type: 'generate',
  },
  {
    ...
    description: 'Try any AI tool from our catalog',
    xpReward: 75,
    completed: true,
    type: 'generate',
  },
  {
    ...
    description: 'Deploy your project to any platform',
    xpReward: 150,
    completed: false,
    type: 'platform',
  },
  ...
  },
  {
    ...
    description: 'Connect a service to your project',
    xpReward: 175,
    completed: false,
    type: 'generate',
  },
  {
    id: 'earn-badge',
    title: 'Earn a Badge',
    description: 'Complete actions to unlock a new badge',
    xpReward: 200,
    completed: false,
    type: 'achievement',
  },
...
export const leaderboard: LeaderboardEntry[] = [
  ...
  },
  {
    ...
    level: 14,
    avatar:
      'https://images.unsplash.com/photo-1494790108755-2616b6a7a428?w=40&h=40&fit=crop&crop=face',
  },
  {
    rank: 4,
    name: 'Marcus Liu',
...
export const createProjects = (userRole?: string) => [
  {
    ...
    description: 'React admin panel with analytics',
    updated: '2 hours ago',
  ...
  },
  {
    ...
    description: 'Next.js blog with CMS integration',
    updated: 'Yesterday',
  ...
  },
  {
    ...
    updated: '2 days ago',
    image: 'https://images.unsplash.com/photo-1512314889357-e157c22f938d?w=200&h=120&fit=crop',
    status: 'active',
    framework: 'React Native',
  },
  {
    name: 'Recipe Manager',
    description: 'Vue.js recipe organizer with AI',
    updated: '3 days ago',
    image: 'https://images.unsplash.com/photo-1504639725590-34d0984388bd?w=200&h=120&fit=crop',
    status: 'draft',
    framework: 'Vue.js',
  },
  {
    ...
    ? [
        {
          ...
          description: 'Flutter app with real-time data',
          updated: '1 week ago',
          image:
            'https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=200&h=120&fit=crop',
          status: 'completed',
          framework: 'Flutter',
        },
        {
          name: 'AI Image Generator',
          description: 'DALL-E integration with custom UI',
          updated: '1 week ago',
          image:
            'https://images.unsplash.com/photo-1676299081847-824916de030a?w=200&h=120&fit=crop',
          status: 'active',
          framework: 'React',
        },
        {
          name: 'Video Streaming Platform',
          description: 'Netflix-style streaming service',
          updated: '2 weeks ago',
          image:
            'https://images.unsplash.com/photo-1574375927938-d5a98e8ffe85?w=200&h=120&fit=crop',
          status: 'active',
          framework: 'Next.js',
        },
        {
        ...
        },
        {
          ...
          updated: '3 weeks ago',
          image:
            'https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=200&h=120&fit=crop',
          status: 'draft',
          framework: 'Web3',
        },
        {
          name: 'AR Shopping Experience',
          description: 'Augmented reality product viewer',
          updated: '1 month ago',
          image:
            'https://images.unsplash.com/photo-1592478411213-6153e4ebc696?w=200&h=120&fit=crop',
          status: 'completed',
          framework: 'React Native',
        },
      ]
