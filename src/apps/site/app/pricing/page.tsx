...
export const metadata: Metadata = {
  ...
  description:
    'Choose the perfect plan for your needs. From free starter to enterprise, FlashFusion scales with you.',
};
...
const faqs = [
  {
    ...
    answer:
      "Yes! You can upgrade, downgrade, or cancel your plan at any time. Changes take effect immediately, and we'll pro-rate any charges.",
  },
  {
    question: 'What payment methods do you accept?',
    answer:
      'We accept all major credit cards (Visa, Mastercard, Amex), PayPal, and wire transfer for Enterprise plans.',
  },
  {
    question: 'Is there a free trial?',
    answer:
      'Professional and Enterprise plans include a 14-day free trial. No credit card required. The Starter plan is free forever.',
  },
  {
    question: 'What happens when I hit my generation limit?',
    answer:
      "On the Starter plan, you'll be notified when approaching your limit. You can upgrade anytime to get unlimited generations.",
  },
  {
    question: 'Do you offer refunds?',
    answer:
      "Yes, we offer a 30-day money-back guarantee. If you're not satisfied, contact support for a full refund—no questions asked.",
  },
  {
    question: 'Can I get a discount for annual billing?',
    answer:
      'Yes! Annual billing saves you 20% compared to monthly. Plus, you get priority support and early access to new features.',
  },
];
                  ...
                  <div className="flex items-baseline gap-2">
                    ...
                    <span
                      style={{
                        fontFamily: 'var(--ff-font-primary)',
                        fontSize:
                          plan.price === 'Custom' ? 'var(--ff-text-3xl)' : 'var(--ff-text-5xl)',
                        fontWeight: 'var(--ff-weight-bold)',
                        color: plan.color,
                      }}
                    >
