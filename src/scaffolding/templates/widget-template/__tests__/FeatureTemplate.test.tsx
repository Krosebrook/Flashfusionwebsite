/**
 * @fileoverview Tests for {{FEATURE_NAME}}
 * @version 1.0.0
 * 
...
describe('FeatureTemplate Component', () => {
  describe('Rendering', () => {
    it('renders with default props', () => {
      ...
      expect(screen.getByText(/{{FEATURE_NAME}}/i)).toBeInTheDocument();
      expect(screen.getByText(/{{FEATURE_DESCRIPTION}}/i)).toBeInTheDocument();
    });
