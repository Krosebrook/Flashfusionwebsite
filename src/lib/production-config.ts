...
export const HEALTH_CHECK = {
  endpoints: ['/api/health', '/api/auth/status', '/api/tools/status', '/api/projects/status'],
  timeout: 5000,
  retries: 3,
};
...
export const SEO_CONFIG = {
  ...
  description:
    'Build complete web applications with AI. 60+ AI tools, real-time collaboration, and deployment to 8+ platforms.',
